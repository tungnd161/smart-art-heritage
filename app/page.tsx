...
export default function Home() {
  return <>
    <header className="shell nav"><Link className="brand" href="/">SMART ART HERITAGE · V1.0</Link><nav className="navlinks"><a href="#di-san">Di sản</a><a href="#hanh-trinh">Hành trình</a><Link href="/giao-vien">Giáo viên</Link></nav><Link className="button ghost" href="/ai-assistant">AI 5A</Link></header>
    <main>
      <section className="hero"><div className="shell"><div className="kicker">Nền tảng giáo dục Mĩ thuật số</div><h1>Di sản là nguồn cảm hứng.<br/>Học sinh là người sáng tạo.</h1><p className="lead">SMART ART HERITAGE kết nối di sản Hưng Yên với quan sát trực quan, nhiệm vụ Mĩ thuật, AI 5A có kiểm soát, Portfolio và đánh giá quá trình.</p><div className="hero-actions"><a className="button" href="#di-san">Bắt đầu khám phá</a><Link className="button ghost" href="/giao-vien">Không gian giáo viên</Link></div><div className="metrics"><div className="metric"><strong>05</strong><span>hồ sơ di sản trọng tâm</span></div><div className="metric"><strong>5A</strong><span>quy trình AI gợi mở</span></div><div className="metric"><strong>3–2–1</strong><span>điều kiện mở AI</span></div></div></div></section>
