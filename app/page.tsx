...
export default function Home() {
  return <>
    <header className="shell nav site-nav"><Link className="brand" href="/"><span>SMART ART</span> HERITAGE</Link><nav className="navlinks"><a href="#di-san">Di sản</a><a href="#hanh-trinh">Hành trình học</a><Link href="/gioi-thieu">Sơ đồ hệ thống</Link></nav><Link className="button ghost nav-cta" href="/ban-do">Khám phá di sản <span>→</span></Link></header>
    <main>
      <section className="hero home-hero"><div className="shell hero-layout"><div className="hero-copy"><div className="kicker">Nền tảng giáo dục Mĩ thuật số</div><h1>Di sản là nguồn cảm hứng.<br/><em>Học sinh</em> là người sáng tạo.</h1><p className="lead">Khơi mở tình yêu di sản Hưng Yên bằng quan sát trực quan, nhiệm vụ Mĩ thuật và AI 5A có trách nhiệm — nơi mỗi ý tưởng đều bắt đầu từ trải nghiệm của học sinh.</p><div className="hero-actions"><Link className="button" href="/ban-do">Bắt đầu khám phá <span>→</span></Link><Link className="button ghost" href="/gioi-thieu">Xem sơ đồ hệ thống</Link></div></div><aside className="hero-note"><span>HÀNH TRÌNH HỌC TẬP</span><strong>Quan sát<br/>→ Suy ngẫm<br/>→ Sáng tạo</strong><p>Di sản là chất liệu.<br/>Mĩ thuật là ngôn ngữ.</p></aside><div className="metrics"><div className="metric"><strong>05</strong><span>hồ sơ di sản<br/>trọng tâm</span></div><div className="metric"><strong>5A</strong><span>quy trình AI<br/>gợi mở</span></div><div className="metric"><strong>3–2–1</strong><span>phiếu hình thành<br/>ý tưởng</span></div></div></div></section>
